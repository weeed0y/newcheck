...
lnbot = TelegramClient("kk_legend", API_ID, API_HASH).start(bot_token=token)


class kk_legend(TelegramClient):
...
if Config.kk_legend_STRING:
    session_name = str(Config.kk_legend_STRING)
